				...
				<!-- Header -->
					<header id="header">
						...
						<ul class="icons">
							...
							<li><a href="https://facebook.com/" class="icon style2 fa-facebook"><span class="label">Facebook</span></a></li>
							<li><a href="https://www.instagram.com/" class="icon style2 fa-instagram"><span class="label">Instagram</span></a></li>
							<li><a href="mailto:test@test.com" class="icon style2 fa-envelope-o"><span class="label">Email</span></a></li>
							<li><a href="tel:123456890" class="icon style2 fa-phone"><span class="label">Telephone</span></a></li>
						</ul>
					</header>
